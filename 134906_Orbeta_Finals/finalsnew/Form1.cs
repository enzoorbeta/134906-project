...
namespace finalsnew
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            using (BinaryReader bw = new BinaryReader(File.Open(@"storage500.csv", FileMode.Open)))
            {
                int n = bw.ReadInt32();
                int m = bw.ReadInt32();
                for (int i = 0; i < m; ++i)
        ...
        private void btnExit_Click(object sender, EventArgs e)
        {
            ...
            using (BinaryWriter bw = new BinaryWriter(File.Open(@"storage500.csv", FileMode.Create)))
            {
